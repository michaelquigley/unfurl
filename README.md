...
The project is currently in implementation. It can reflow plain, non-container paragraphs with hard-break preservation and preserves the non-container Markdown constructs implemented so far, including GFM tables; list, blockquote, and property-test work lands in later chunks according to `docs/future/unfurl-work-order.md`.
